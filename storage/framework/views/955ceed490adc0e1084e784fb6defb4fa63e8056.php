...
<?php endif; ?>
                ...
                <?php if($exportable): ?>
                    <div x-data="{ init() {
                        ...
                        <button wire:click="export" class="flex items-center px-3 text-xs font-medium tracking-wider text-green-500 uppercase bg-white border border-green-400 space-x-2 rounded-md leading-4 hover:bg-green-200 focus:outline-none"><span><?php echo e(__('Export')); ?></span>
                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('l3442179553-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3442179553-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3442179553-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3442179553-0');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('l3442179553-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php /**PATH C:\laragon\www\mesvacancesv2\vendor\mediconesystems\livewire-datatables\src/../resources/views/livewire/datatables/datatable.blade.php ENDPATH**/ ?>