...
<html lang="fr">
  ...
  <body class="bg-gradient-to-r from-indigo-900 to-indigo-300 leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <div class="pt-10">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
          <p class="uppercase tracking-loose w-full text-2xl">Fancy a vacation?</p>
          <h1 class="my-4 text-5xl font-bold leading-tight">
          You are in the right place !
          </h1>
          <?php if(auth()->guard()->check()): ?>
            <a href="<?php echo e(route('rents')); ?>" class="cursor-pointer mx-auto lg:mx-0 bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-110 duration-300 ease-in-out">
            My Dashboard
            </a>
          <?php else: ?>
        ...
        <div class="w-full md:w-3/5 py-6 text-center">
          <img class="w-full md:w-4/5 z-50" src="<?php echo e(asset('img/beach.png')); ?>" />
        </div>
      </div>
    </div>
      ...
      <div class="container max-w-5xl mx-auto m-8">
        ...
        <div class="flex flex-wrap">
          <div class="w-5/6 sm:w-1/2 p-6">
            ...
            We all need to relax            </h3>
            <p class="text-gray-600 mb-8">
            Our lodgings are a haven of peace so that your holidays are a great success.            </p>
          </div>
        ...
        <div class="flex flex-wrap flex-col-reverse sm:flex-row">
          ...
          <div class="w-full sm:w-1/2 p-6 mt-6">
            <div class="align-middle">
              ...
              <p class="text-gray-600 mb-8">
              In a natural and festive environment you can enjoy all our recreational activities.              </p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="container mx-auto text-center py-6 mb-12">
      ...
      Just a click away for a wonderful stay!      </h3>      
      <div class="w-full mb-4">
      ...
      <?php $__currentLoopData = $homes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $home): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <h3 class="my-6 text-3xl leading-tight">
          <?php echo e($home->text1); ?>

        </h3> 
        <h3 class="my-6 text-3xl leading-tight">
          <?php echo e($home->text2); ?>

        </h3> 
        <h3 class="my-6 text-3xl leading-tight">
          <?php echo e($home->text3); ?>

        </h3> 
        <img class="w-full p-6" src="<?php echo e(asset('img/' . $home->image)); ?>" alt="Gite">
        <h3 class="my-6 text-3xl leading-tight">
        Don't wait to book!
        </h3>
        <p class="my-6 text-1xl leading-tight">Click on the first day of your stay (arrival from 4:00 p.m.) then drag to the last day (departure the next day before 10:00 a.m.)</p>
        <p class="my-6 text-1xl leading-tight">The days in red are unfortunately not available</p>
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('calendar', ['idCalendar' => $home->id])->html();
} elseif ($_instance->childHasBeenRendered('MN4g2K7')) {
    $componentId = $_instance->getRenderedChildComponentId('MN4g2K7');
    $componentTag = $_instance->getRenderedChildComponentTagName('MN4g2K7');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('MN4g2K7');
} else {
    $response = \Livewire\Livewire::mount('calendar', ['idCalendar' => $home->id]);
    $html = $response->html();
    $_instance->logRenderedChild('MN4g2K7', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <div class="w-full mb-4">
          ...
          <div class="flex-1">
            ...
            <ul class="list-reset mb-6">
              <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                <a href="#" class="no-underline hover:underline text-gray-800 hover:text-pink-500">Legal data</a>
              </li>
              <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                <a href="#" class="no-underline hover:underline text-gray-800 hover:text-pink-500">Personal data</a>
              </li>
            </ul>
          </div>
          <div class="flex-1">
...
} elseif ($_instance->childHasBeenRendered('T1qUPhR')) {
    $componentId = $_instance->getRenderedChildComponentId('T1qUPhR');
    $componentTag = $_instance->getRenderedChildComponentTagName('T1qUPhR');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('T1qUPhR');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('T1qUPhR', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    @livewireUIScripts
...
<?php /**PATH C:\laragon\www\mesvacancesv2\resources\views/home.blade.php ENDPATH**/ ?>